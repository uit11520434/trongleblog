...
<div id="comments" class="comments-area comments">
    ...
    <?php
        ...
        $fields =  array(
            'author' => '<div class="col-md-6"><div class="row"><div class="col-md-12"><input id="author" name="author" type="text" placeholder="'. __( 'Name', 'themeum' ) .'" value="" size="30"' . $aria_req . '/></div>',
            'email'  => '<div class="col-md-12"><input id="email" name="email" type="text" placeholder="'. __( 'Email', 'themeum' ) .'" value="" size="30"' . $aria_req . '/></div>',
            'url'  => '<div class="col-md-12"><input id="url" name="url" type="text" placeholder="'. __( 'Website url', 'themeum' ) .'" value="" size="30"/></div></div></div>',
        );
        ...
        $comments_args = array(
            ...
            'comment_notes_after'       => '',
            'comment_field'             => '<div class="clearfix"></div><div class="col-md-12"><textarea id="comment" placeholder="'. __( 'Comment', 'themeum' ) .'" name="comment" aria-required="true"></textarea></div>',
