...
<!--style-->
<link rel="stylesheet" href="<?php echo plugins_url(); ?>/themeum-prolog-shortcodes/css/style.css" />
<!--scripts-->
<script src="<?php echo plugins_url(); ?>/themeum-prolog-shortcodes/js/popup.js"></script>
